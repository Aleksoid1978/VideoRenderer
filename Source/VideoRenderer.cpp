...
STDMETHODIMP CMpcVideoRenderer::Run(REFERENCE_TIME rtStart)
{
	...
	if (m_bUsedD3D11) {
		...
		static bool bSubInvAlpha = xySubFilterInGraph();
		m_bSubInvAlpha = bSubInvAlpha;
		m_DX11_VP.Start();
	} else {
		m_DX9_VP.Start();
	}
...
STDMETHODIMP CMpcVideoRenderer::GetPages(CAUUID* pPages)
{
	...
	static GUID GUIDS[] = {
		{ 0xFE6F404E, 0x6E74, 0x4414, 0xB3, 0x3C, 0xA5, 0x87, 0xB1, 0x02, 0x25, 0x49 },
		{ 0x7C737B87, 0x2760, 0x4183, 0xB5, 0xB4, 0xAC, 0xA7, 0xC6, 0x4D, 0xD7, 0x20 },
		{ 0x109F160B, 0xB6B0, 0x4C9D, 0x90, 0x97, 0x85, 0x6F, 0xBE, 0xEB, 0xDC, 0x66 },
		{ 0x8AC911B6, 0xDEFB, 0x474C, 0x98, 0x60, 0x9E, 0x00, 0x3C, 0xCC, 0xB2, 0x61 },
		{ 0xEF1C9B46, 0xFAB9, 0x45F7, 0x87, 0xCC, 0xCD, 0x9B, 0x97, 0x5E, 0x29, 0x4D },
		{ 0x8C91CE9C, 0x6911, 0x45BD, 0xA1, 0x35, 0x48, 0x82, 0x75, 0x16, 0x7B, 0x8C },
